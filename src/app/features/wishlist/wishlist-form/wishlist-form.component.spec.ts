...
describe('WishlistComponent', () => {
  ...
  describe('deleteMyGame', () => {
    ...
    it('should delete my game after confirmation', () => {
      ...
      expect(confirmService.confirm).toHaveBeenCalledWith(
        'Confirmar Exclusão',
        'Deseja realmente remover "The Witcher 3" da sua lista de desejos?'
      );
      expect(myGameService.deleteMyGame).toHaveBeenCalledWith(1);
      expect(component.showToast()).toBe(true);
      expect(component.toastMessage()).toBe('Jogo removido da lista de desejos com sucesso!');
    ...
    it('should handle error when deleting my game', () => {
      ...
      expect(component.showToast()).toBe(true);
      expect(component.toastMessage()).toBe('Erro ao remover jogo da lista de desejos');
      expect(component.toastType()).toBe('error');
    });
    ...
    it('should use fallback text when game has no title', () => {
      ...
      expect(confirmService.confirm).toHaveBeenCalledWith(
        'Confirmar Exclusão',
        'Deseja realmente remover "este jogo" da sua lista de desejos?'
      );
    });
  });
  ...
  describe('onFormSubmit', () => {
    ...
    it('should create new my game when not editing', () => {
      ...
      expect(component.showToast()).toBe(true);
      expect(component.toastMessage()).toBe('Jogo adicionado à lista de desejos com sucesso!');
